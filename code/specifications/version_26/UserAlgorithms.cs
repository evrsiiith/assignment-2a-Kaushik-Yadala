...
namespace Version_26 // Ensure this matches your VReqDV version folder name exactly!
{
    public static class UserAlgorithms
    {
        ...
        public static void DropSphere(GameObject obj)
        {
            ...
            VReqDV.StateAccessor.SetState(obj.name, "rolling", obj, "Version_26");
        }
        ...
        public static void SetColorRed(GameObject obj)
        {
            ...
            VReqDV.StateAccessor.SetState(obj.name, "red", obj, "Version_26");
        }
        ...
        public static void SetColorGreen(GameObject obj)
        {
            ...
            // Tell VReqDV the state has successfully changed
            VReqDV.StateAccessor.SetState(obj.name, "green", obj, "Version_26");
        }
        ...
        public static void SlideDoorOpen(GameObject obj)
        {
            ...
            VReqDV.StateAccessor.SetState(obj.name, "open", obj, "Version_26");
        }
        ...
        public static void SlideDoorClosed(GameObject obj)
        {
            ...
            VReqDV.StateAccessor.SetState(obj.name, "closed", obj, "Version_26");
        }
    }
}
